    ...
    constructor(props) {
        ...
        this.content = [
            ...
            },
            {
                ...
                link: "",
                content: [
                    "Lead development of the Django REST API backend for Espresso Insights' reporting services, \
                    part of their financial technology platform that provides private company performance insights via \
                    automated data ingestion and advanced analytics services.",
                    "Developed and deployed a Natural Language Processing based chart of accounts classifier with \
                    Tensorflow and Keras into a production environment.",
                    "Developed enhancements to Insights reporting services within a cloud native application architecture including: \
                    continuous integration and delivery pipelines through Heroku / AWS, micro-services, containers, push notifications \
                    to provide async workflows and user messages using Django Channels (websockets). \
                    Additional enhancements include api versioning, autogenerated documentation, and log aggregation."
                ],
                items: [
